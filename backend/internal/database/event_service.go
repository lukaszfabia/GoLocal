...
type EventService interface {
	FilterEvents(params map[string]any, limit int) ([]*models.Event, error)
}
...
func (e *eventServiceImpl) FilterEvents(params map[string]any, limit int) ([]*models.Event, error) {
	q := e.db.
		Preload("Location").
